...
%				}}
				...
				{\Large\bf \textbf{ỨNG DỤNG HỌC SÂU TRONG BÀI TOÁN \\
...
%\textbf{Input:} \\
%Ảnh viễn thám được lưu ở định dạng .tif, có kích thước khá lớn (từ vài chục MB đến GB) \\ 
%\textbf{Tiền xử lý:} \\
%Ảnh đầu vào sẽ được chia nhỏ thành các ảnh có kích thước window size = $256 \times 256$ (bằng với kích thước trong tập ảnh training),  với tỉ lệ \textit{overlap} giữa các tấm ảnh là $0.5$ \ref{fig:demo_prepare_data} \\
% \begin{figure}[!htb]
%	\centering
...
Dữ liệu sử dụng trong bài toán này được cung cấp bởi thầy giáo hướng dẫn TS.  Lê Hải Hà.  Dữ liệu gốc bao gồm 2 thư mục,  nỗi thư mực gồm một vài ảnh ở định dạng GeoTif và các \textbf{shapefile} chứa toạ độ các bounding box trong các bức ảnh đó
 \begin{figure}[!htb]
	\centering
...
\end{figure}
 ...
 \begin{figure}[!htb]
	\centering
	\includegraphics[width=1\linewidth, height=7cm]{Images/deploymentStage1}
	\caption{Dữ liệu đầu vào để phát hiện vật thể}
